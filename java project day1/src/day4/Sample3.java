...
public class Sample3 {
	...
	public static void main(String[] args) {
		// Call by value 
		// 메소드에 값(primitive type)을 전달하는 것과 객체(reference type)를 전달하는 것에는 큰 차이가 있다. 이것은 매우 중요하기 때문에 이전에 잠깐 언급했지만 다시한번 자세히 알아보자.
		...
		// Counter 클래스는 count라는 객체변수를 가지고 있다. Sample클래스의 main메소드는 
		// Counter클래스에 의해 생성된 객체의 객체변수 count의 값을 Updater클래스를 이용하여 
		// 증가시키려고 시도하는 예제이다.
		...
		// 이전 예제와의 차이점은 update 메소드의 입력항목이다. 이전에는 int count와 같이 값을 전달받았다면
