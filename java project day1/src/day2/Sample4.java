...
public class Sample4 {
	...
	public static void main(String[] args) {
		// if 문
		// if문의 기본 구조 -다음의 구조가 if와 else를 사용하는 기본 구조이다.
		//if (조건문) {
		//    <수행할 문장1>;
		//    <수행할 문장2>;
		//    ...
		...
		// 조건문을 테스트 해서 참이면 if문에 속한 문장들을 수행하고 
		// 조건문이 거짓이면 else문에 속한 문장들을 수행한다
		...
		// "지갑에 돈이 있으면 택시를 타고, 지갑엔 돈이 없지만 카드가 있으면 택시를 타고, 
		// 돈도 없고 카드도 없으면 걸어가라“
		...
		// if와 else만으로 위의 문장을 표현 하려면 다음과 같이 해야한다.
			...
			// else if는 이전 조건문이 거짓일 때 수행된다. 따라서 위 예에서 
			// pocket.contains("money") 문장이 거짓이므로 else if 문이 수행되고
			// hasCard가 true이므로 "택시를 타고 가라"가 출력된다.
